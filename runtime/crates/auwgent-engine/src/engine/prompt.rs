...
impl AuwgentEngine {
    ...
    fn generate_main_prompt(&self) -> AuwgentResult<String> {
        ...
        let parsed_prompt: auwgent_ir_schema::ExpressionIR =
        ...
        *self.binding_context_keys.lock().unwrap() = binding_context_keys.clone();
        ...
        if protocol == "block" {
            let intents = auwgent_prompt::generate_block_protocol_prompt_with_binding_rules(
                &self.ir,
