...
use auwgent_native::NativeCallableRegistry;
...
use auwgent_protocol::BlockOrchestrator as Orchestrator;
use auwgent_protocol::{JsonlEventBuffer, PartialIntentState, StructuredOutputEvent};
