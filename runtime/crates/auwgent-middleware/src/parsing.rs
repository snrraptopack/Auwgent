use crate::events::*;
use auwgent_runtime_core::{IntentControl, TurnMetadata};
...
/// Receives a JSON string payload and may return an optional JSON string response.
#[cfg(not(target_arch = "wasm32"))]
pub type MiddlewareCallback = RuntimeCallback<
    dyn Fn(String) -> RuntimeBoxFuture<'static, Option<String>> + Send + Sync,
>;
