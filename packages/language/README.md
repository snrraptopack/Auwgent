...
- [src/auwgent.langium](src/auwgent.langium) -  The grammar definition of your language
- [src/auwgent-module.ts](src/auwgent-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/auwgent-validator.ts](src/auwgent-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/auwgent.monarch.ts](src/syntaxes/auwgent.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/auwgent.tmLanguage.json](syntaxes/auwgent.tmLanguage.json) - Textmate based syntax highlighting instructions.
