...
import type {
    ...
    TypeDeclaration, Types, VariableDeclaration, Helper, ToolFunction, WorkFlowConfig,
...
import {
    ...
    isBaseType, isObjectType, isUnionType, isVariableDeclaration, isVariableRef,
...
export class AuwgentHoverProvider extends AstNodeHoverProvider {
    ...
    protected override getAstNodeHoverContent(node: AstNode): string | undefined {
        ...
        if (isVariableRef(node)) {
            ...
            if (ref && isVariableDeclaration(ref)) {
    ...
    private inferMemberAccessType(access: MemberAccess): string {
        ...
        if (isVariableDeclaration(objectRef)) {
