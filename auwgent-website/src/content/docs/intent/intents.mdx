...
1. Intent families and lifecycle: model-originated vs runtime-originated, and when each appears.
2. Intent payload contracts: exact JSON shape per default intent.
3. Streaming path: how **onIntentPartial** differs from **onIntent**, plus the partial envelope fields.
4. Control semantics: where skip/override apply and where they do not.
5. Custom intents: declaration, shape, and dispatch behavior.
6. Handler patterns: practical routing patterns in TypeScript and Python.
