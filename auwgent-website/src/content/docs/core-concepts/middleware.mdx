...
<Tabs>
  ...
  <TabItem label="Python">
    ...
    class ScopedMiddleware:
        ...
        async def onIntent(self, name: str, value: dict, ctx: dict):
            if ctx.get("activeAgent") == "BillingHelper":
...
<Tabs>
  ...
  <TabItem label="Python">
    ...
    class ContextMiddleware:
        ...
        async def onRunStart(self, session: dict, ctx: dict) -> dict:
...
<Tabs>
  ...
  <TabItem label="Python">
    ...
    class ObservabilityMiddleware:
        ...
        async def onRunComplete(self, session: dict, ctx: dict) -> None:
...
<Tabs>
  ...
  <TabItem label="Python">
    ...
    class ResearcherMiddleware:
        ...
        async def onLLMStart(self, prompt: str, ctx: dict) -> None:
...
<Tabs>
  ...
  <TabItem label="Python">
    ...
    class SessionMiddleware:
        ...
        async def onRunComplete(self, session: dict, ctx: dict) -> None:
            await db.sessions.save(user_id, session)
