...
class MainTools(Protocol):
    # ...
    async def deleteDatabase(self, *, id: float) -> str: ...
...
class MainErrorIntent(TypedDict):
    message: str
class MaindeleteWorkflowArgs(TypedDict, total=False):
    id: float

MaindeleteWorkflowResultValue = str

class MaindeleteWorkflowCall(TypedDict):
    type: Literal["delete"]
    args: MaindeleteWorkflowArgs

class MaindeleteWorkflowResult(TypedDict):
    name: Literal["delete"]
    result: MaindeleteWorkflowResultValue

MainIntentValue = Union[
    MainResponseTextIntent,
    MainResponseSchemaIntent,
    MainErrorIntent,
    MaindeleteWorkflowCall,
    MaindeleteWorkflowResult,
]
MainWorkflowCallIntentValue = Union[MaindeleteWorkflowCall]
MainWorkflowResultIntentValue = Union[MaindeleteWorkflowResult]
MainIntentName = Literal["response_text", "response_schema", "error", "workflow_call", "workflow_result"]
...
class MainBaseIntentHandler:
    ...
    def error(self, intent: MainErrorIntent, agent_name: str) -> Union[MainIntentHandlerReturn, Awaitable[MainIntentHandlerReturn]]:
        pass
    def workflow_call(self, intent: Union[MaindeleteWorkflowCall], agent_name: str) -> Union[MainIntentHandlerReturn, Awaitable[MainIntentHandlerReturn]]:
        pass
    def workflow_result(self, intent: Union[MaindeleteWorkflowResult], agent_name: str) -> Union[MainIntentHandlerReturn, Awaitable[MainIntentHandlerReturn]]:
        pass
