...
MainResponseSchemaIntent = Union[MainAOutputResponseSchemaIntent, MainMainOutputResponseSchemaIntent]
...
MainAHelperResultValue = TypedDict('_TextOutput', {"text": str}, total=False)
...
MainHelperCallIntentValue = Union[MainAHelperCall]
MainHelperResultIntentValue = Union[MainAHelperResult]
MainIntentName = Literal["response_text", "response_schema", "error", "helper_call", "helper_result"]
...
class MainBaseIntentHandler:
    ...
    def error(self, intent: MainErrorIntent, agent_name: str) -> Union[MainIntentHandlerReturn, Awaitable[MainIntentHandlerReturn]]:
        pass
    def helper_call(self, intent: Union[MainAHelperCall], agent_name: str) -> Union[MainIntentHandlerReturn, Awaitable[MainIntentHandlerReturn]]:
        pass
    def helper_result(self, intent: Union[MainAHelperResult], agent_name: str) -> Union[MainIntentHandlerReturn, Awaitable[MainIntentHandlerReturn]]:
        pass
